* [Density Functional Theory (DFT)](#density-functional-theory-dft)
   * [Specification of Basis Sets for the DFT Module](#specification-of-basis-sets-for-the-dft-module)
   * [VECTORS and MAX_OVL: KS-MO Vectors](#vectors-and-max_ovl-ks-mo-vectors)
   * [XC and DECOMP: Exchange-Correlation Potentials](#xc-and-decomp-exchange-correlation-potentials)
      * [Exchange-Correlation Functionals](#exchange-correlation-functionals)
      * [Setting up common exchange-correlation functionals](#setting-up-common-exchange-correlation-functionals)
      * [Combined Exchange and Correlation Functionals](#combined-exchange-and-correlation-functionals)
   * [XC Functionals Summary](#xc-functionals-summary)
      * [References for XC Functionals](#references-for-xc-functionals)
      * [Meta-GGA Functionals](#meta-gga-functionals)
      * [Range-Separated Functionals](#range-separated-functionals)
      * [SSB-D functional](#ssb-d-functional)
      * [Semi-empirical hybrid DFT combined with perturbative MP2](#semi-empirical-hybrid-dft-combined-with-perturbative-mp2)
      * [LB94 and CS00: Asymptotic correction](#lb94-and-cs00-asymptotic-correction)
   * [Sample input file](#sample-input-file)
   * [ITERATIONS or MAXITER: Number of SCF iterations](#iterations-or-maxiter-number-of-scf-iterations)
   * [CONVERGENCE: SCF Convergence Control](#convergence-scf-convergence-control)
      * [CONVERGENCE DAMP Keyword](#convergence-damp-keyword)
      * [CONVERGENCE LSHIFT Keyword](#convergence-lshift-keyword)
      * [CONVERGENCE DIIS Keyword](#convergence-diis-keyword)
      * [CONVERGENCE FAST Keyword](#convergence-fast-keyword)
   * [CDFT: Constrained DFT](#cdft-constrained-dft)
   * [SMEAR: Fractional Occupation of the Molecular Orbitals](#smear-fractional-occupation-of-the-molecular-orbitals)
   * [FON: Calculations with fractional numbers of electrons](#fon-calculations-with-fractional-numbers-of-electrons)
      * [Restricted](#restricted)
      * [Unrestricted](#unrestricted)
   * [OCCUP: Controlling the occupations of molecular orbitals](#occup-controlling-the-occupations-of-molecular-orbitals)
   * [GRID: Numerical Integration of the XC Potential](#grid-numerical-integration-of-the-xc-potential)
      * [Angular grids](#angular-grids)
         * [Gauss-Legendre angular grid](#gauss-legendre-angular-grid)
         * [Lebedev angular grid](#lebedev-angular-grid)
      * [Partitioning functions](#partitioning-functions)
      * [Radial grids](#radial-grids)
      * [Disk usage for Grid](#disk-usage-for-grid)
   * [TOLERANCES: Screening tolerances](#tolerances-screening-tolerances)
   * [DIRECT, SEMIDIRECT and NOIO: Hardware Resource Control](#direct-semidirect-and-noio-hardware-resource-control)
   * [ODFT and MULT: Open shell systems](#odft-and-mult-open-shell-systems)
   * [CGMIN: Quadratic convergence algorithm](#cgmin-quadratic-convergence-algorithm)
   * [RODFT: Restricted open-shell DFT](#rodft-restricted-open-shell-dft)
   * [SIC: Self-Interaction Correction](#sic-self-interaction-correction)
   * [MULLIKEN: Mulliken analysis](#mulliken-mulliken-analysis)
   * [FUKUI: Fukui Indices](#fukui-fukui-indices)
   * [BSSE: Basis Set Superposition Error](#bsse-basis-set-superposition-error)
   * [DISP: Empirical Long-range Contribution (vdW)](#disp-empirical-long-range-contribution-vdw)
   * [NOSCF: Non Self-Consistent Calculations](#noscf-non-self-consistent-calculations)
   * [XDM: Exchange-hole dipole moment dispersion model](#xdm-exchange-hole-dipole-moment-dispersion-model)
   * [Print Control](#print-control)
* [Spin-Orbit Density Functional Theory (SODFT)](#spin-orbit-density-functional-theory-sodft)
* [SYM and ADAPT](#sym-and-adapt)
